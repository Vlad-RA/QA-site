...
const skillsData = [
    ...
    modalContent: {
      ...
      description: (
        <div className="space-y-3">
          <div>Наши методологии тестирования охватывают широкий спектр, включая:</div>
          ...
          <div>Этот подход гарантирует, что программное обеспечение не только соответствует техническим требованиям, но и обеспечивает положительный пользовательский опыт. Мы используем различные инструменты и техники для выявления дефектов на ранних стадиях разработки.</div>
        </div>
      ),
      imageName: 'Tests.png',
    },
  },
  {
    ...
    modalContent: {
      ...
      description: (
        <div className="space-y-3">
          <div>Автоматизация - ключ к современному QA, позволяющая:</div>
          <ul className="list-disc list-inside space-y-1">
          ...
          <div>Мы специализируемся на выборе правильных инструментов и фреймворков для автоматизации, чтобы максимизировать ROI и ускорить выход продукта на рынок.</div>
        </div>
      ),
      imageName: 'Automat.png',
    },
  },
  {
    icon: BarChart3,
    ...
    modalContent: {
      ...
      description: (
        <div className="space-y-3">
          <div>QA, основанное на данных, включает:</div>
          <ul className="list-disc list-inside space-y-1">
          ...
          <div>Сбор и анализ данных помогает нам принимать обоснованные решения и фокусировать усилия на наиболее критичных областях, повышая общую эффективность процесса QA.</div>
        </div>
      ),
      imageName: 'Analit.png',
    },
  },
  {
    icon: ShieldCheck,
    ...
    modalContent: {
      ...
      description: (
        <div className="space-y-3">
          <div>Безопасность превыше всего. Наш подход включает:</div>
          <ul className="list-disc list-inside space-y-1">
          ...
          <div>Мы интегрируем тестирование безопасности на всех этапах жизненного цикла разработки (DevSecOps), чтобы обеспечить защиту данных и доверие пользователей.</div>
        </div>
      ),
      imageName: 'Sec.png',
    },
